...
if ("serviceWorker" in navigator) {
  ...
  navigator.serviceWorker.addEventListener("controllerchange", () => {
    ...
    // hizo nada — y si la persona sigue usando la app sin nunca cambiar de
...
function wireEvents() {
  ...
  $("#input-total-fact").addEventListener("change", () => registrarEdicionManualFacturado("total"));
  ...
  // recién al confirmar "Guardar" (cancelar el modal no borra nada).
