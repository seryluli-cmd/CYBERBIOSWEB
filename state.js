...
// es la misma para todos los dispositivos (Sergio, colaboradores), así que
// viene incluida de una vez y nadie tiene que pegarla a mano en el primer
...
// de elegir negocio en cuanto el array tiene más de un elemento. El id
// "cyberbios" tiene que coincidir con el campo `negocio` ya guardado en
// los gastos/facturaciones existentes en Firestore.
...
export const state = {
  ...
  selectedFotoFacturadoBlob: null, // foto comprimida, lista para subir (modal de Cierre de Turno — sigue siendo una sola)
  fotosLimpiezaHecha: false,

  socios: [],           // ["Sergio"] — el/los dueño(s), entran en el reparto (acá siempre 1)
  colaboradores: [],    // ["Miguel", ...] — pueden pagar/cargar, NO entran en el reparto
  ...
  negocioActual: null,  // "cyberbios" (siempre — acá hay un solo negocio)
