...
// escriben el estado compartido de la app (ver state.js).
// ============================================================
...
// 12 meses cubre de sobra la navegación mes a mes que ya existe en Gastos/
// Facturado/Resumen (ver gastosMesOffset y afines) sin traer años de
// historia que casi nunca se consultan.
